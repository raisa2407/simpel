...
import { ChevronRight, FileText, Upload, CheckCircle, Send, Clock, AlertCircle, FileCheck, Edit, Download, UserCheck, Settings, Mail, Calendar, Paperclip, Shield, Eye, Save, Zap, Bell, Archive, Check, Italic } from 'lucide-react'
        ...
        <>
            <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-4 sm:py-6">
                <nav className="flex items-center space-x-1.5 sm:space-x-2 text-xs sm:text-sm mb-4 sm:mb-6 overflow-x-auto">
                    ...
                    <ChevronRight className="w-3 h-3 sm:w-4 sm:h-4 text-gray-400 flex-shrink-0" />
                    <span className="text-gray-900 font-semibold whitespace-nowrap">Pemohon PUU</span>
                </nav>
                ...
                <div className="mb-6 sm:mb-8 md:mb-10 text-center px-2">
                    ...
                    <div className="relative inline-block">
                        <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-red-600 mb-2 relative px-2">
                            Panduan Permohonan Pemohon PUU
                    ...
                    <p className="mt-4 sm:mt-5 md:mt-6 text-xs sm:text-sm md:text-base text-gray-600 max-w-2xl mx-auto px-2 sm:px-4 leading-relaxed">
                        Ikuti langkah-langkah berikut untuk mengajukan permohonan Pengujian Undang-Undang (PUU)
                    </p>
                </div>
