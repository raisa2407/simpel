  ...
  return (
    ...
    <div className="max-w-7xl mx-auto space-y-3 md:space-y-6">
      ...
      <nav className="flex items-center space-x-2 text-sm mb-6 sm:mb-8">
        ...
        <span className="text-gray-900 font-semibold">Permohonan PUU</span>
      </nav>
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6 md:mb-8">
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <div className="min-w-0 flex-1">
              <h1 className="text-lg md:text-2xl lg:text-3xl font-bold text-gray-900 tracking-tight">Permohonan Online Pemohon PUU (Pengujian Undang-Undang)</h1>
